...
def get_prediction(db: Session, prediction_id: int) -> models.Prediction:
...
def get_sorted_predictions_by_image(db: Session, image_id: int) -> List[models.Prediction]:
...
def get_top_predictions_by_image(db: Session, image_id: int, k: int) -> List[models.Prediction]:
	return (db.query(models.Prediction)
